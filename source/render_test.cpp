...
int main(int argc, char* argv[]){
    ...
    std::shared_ptr<Material> mat_ptr(new Material{"test mat", {0.8f, 0.2f, 0.2f}, {0.9f, 0.9f, 0.9f}, {0.2f, 0.2f, 0.2f}, 5.0f, 1.0f, 0.5f});
    ...
    std::shared_ptr<Box> box_ptr2(new Box{{-1.5f,-1.0f,-1.0f}, {1.0f,-3.0f,-10.0f}, "test_box", mat_ptr});
    Light light_1{"new light", 1.0f, {0.5f, 0.5f, 0.5f}, {3.0f, 1.0f, 0.0f}};
