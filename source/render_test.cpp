...
int main(int argc, char* argv[]){
    ...
    std::shared_ptr<Material> mat5_ptr(new Material{"white", {1.0f, 1.0f, 1.0f}, {0.5f, 0.5f, 0.5f}, {0.5f, 0.5f, 0.5f}, 100.0f, 1.0f, 0.7f});
    ...
    Light light_2{"new light1", 30.0f, {0.5f, 0.5f, 0.5f}, {0.6f, 3.0f, 0.0f}};
