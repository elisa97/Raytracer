...
int main(int argc, char* argv[]){
    ...
    std::shared_ptr<Material> mat_ptr(new Material{"test mat", {2.0f, 0.5f, 1.0f}, {0.4f, 0.2f, 0.8f}, {0.2f, 0.4f, 0.5f}, 2.0f});
    std::shared_ptr<Material> matz_ptr(new Material{"test matz", {0.5f, 2.3f, 1.3f}, {0.4f, 0.2f, 0.8f}, {0.2f, 0.4f, 0.5f}, 2.0f});
    std::shared_ptr<Sphere> sphere_ptr(new Sphere{{0.0f, 0.0f, -2.0f}, 0.2f, "test_sphere", mat_ptr});
