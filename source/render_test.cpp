...
int main(int argc, char* argv[]){
    ...
    std::shared_ptr<Material> mat_ptr(new Material{"test mat", {0.7f, 0.7f, 0.7f}, {0.9f, 0.9f, 0.9f}, {0.2f, 0.4f, 0.5f}, 10.0f, 0.0f, 0.0f});
    std::shared_ptr<Material> matz_ptr(new Material{"test matz", {0.7f, 0.7f, 0.7f}, {0.8f, 0.5f, 0.8f}, {0.2f, 0.4f, 0.5f}, 10.0f, 1.0f, 0.0f});
    std::shared_ptr<Sphere> sphere_ptr(new Sphere{{0.0f, -0.5f, -4.0f}, 0.4f, "test_sphere", mat_ptr});
    ...
    Light light_1{"new light", 50.0f, {0.5f, 0.5f, 0.5f}, {5.0f, 0.0f, 0.0f}};
